from turtle import Turtle, Screen, Shape, numinput
import turtle
from random import randint
level=turtle.numinput('LEVEL [3-9]: ','','enter level number',3,9)
# SCREEN
screen = Screen()
...
ball_move_horiz = level           # Horizontal movement per frame
ball_move_vert  = level           # Vertical movement per frame
...
def frame () :
    ...
    # schedule this function to be called again a bit later
    
write_scores()
framerate_ms = 3  # Every how many milliseconds must frame function be called?
frame()
